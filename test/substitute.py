...
class FuncSubstitute:
    ...
    def train_approx(self, use_provided_data=True, use_provided_approx=False, user_data=None, num_samples=None, epochs=5):
        """
    ...
    # def torch_compile_approx(self, export_dir=".", exported_names=["approx_predict", "approx_learn"]):
    ...
    def load_mlir_from_file(mlir_path):
        ...
        What actually happens under the hood:
            iree-compile --iree-input-type=auto --iree-vm-bytecode-module-output-format=flatbuffer-binary --iree-hal-target-backends=llvm-cpu --iree-llvmcpu-embedded-linker-path=/home/hao/iree-build/myvenv/lib/python3.11/site-packages/iree/compiler/tools/../_mlir_libs/iree-lld --mlir-print-debuginfo --mlir-print-op-on-diagnostic=false ./output.mlir -compile-to=global-optimization
        """
