...
def test():
    ...
    test_kernel = get_approx_kernel(FEATURES_SHAPE, OUTPUT_SHAPE, batch_size=BATCH_SIZE)
    ...
    func_sub.train_approx(use_provided_data=True, user_data=x_train[:num_samples], epochs=epochs)
